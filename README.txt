...
Current State:
Right now, the program runs for an initial 120 seconds, a new customer arrives at random 1-5 minutes after the previous customer arrival. The customer also is assigned a random "shoptime" that ranges from 5-35 seconds long. Each customer has its own thread and the threads are all executing concurrently.
